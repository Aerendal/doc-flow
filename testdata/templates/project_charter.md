...
## Cel dokumentu
Formalnie zatwierdzić projekt: określić cele, zakres, budżet, harmonogram wysokiego poziomu, role i odpowiedzialności oraz kryteria sukcesu. Daje zielone światło do planowania i realizacji.

## Zakres i granice
Obejmuje: cel biznesowy, zakres (in/out), główne deliverables, wskaźniki sukcesu, budżet wstępny, interesariuszy, role/RACI, główne ryzyka i założenia, model governance. Nie obejmuje: szczegółowego WBS ani planu iteracji.

## Wejścia i wyjścia
- Wejścia: wizja/Problem Statement/BRD, Feasibility Study, wstępne estymaty kosztów, ograniczenia organizacyjne, decyzje strategiczne.
- Wyjścia: zatwierdzony Charter, zakres + kryteria sukcesu, sponsor i RACI, wstępny budżet i kamienie milowe, lista ryzyk startowych.
...
- Konsumuje: Wizję/BRD, Feasibility Study, decyzje kierownictwa.
- Dostarcza do: WBS, Project Timeline/Schedule, Risk Register, Change Management Plan.

## Powiązania sekcja↔sekcja
- Zakres → rozwinięcie w WBS i Planie wydawniczym.
- KPI/kamienie → powiązanie z monitorowaniem postępu i raportowaniem.
- Ryzyka startowe → rozwinięcie w Risk Register i Planie mitygacji.
...
- Zakres (in/out) i główne deliverables
- Kryteria sukcesu / KPI
- Sponsor, interesariusze, role i RACI
- Budżet wstępny i źródła finansowania
- Kamienie milowe wysokiego poziomu
- Założenia i ograniczenia
- Ryzyka startowe i plan mitygacji
- Model governance i komunikacja
- [Sekcja 3]
